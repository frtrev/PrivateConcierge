...
import '../services/downloads/open_street_map_package.dart';
...
class AppDependencies {
  ...
  static Future<AppDependencies> create() async {
    ...
    final downloadClient = HttpPublicDownloadClient();
    final packages = OpenStreetMapRegionPackageManager(
      preferences,
      poi,
      OpenStreetMapPackageSource(downloadClient),
    );
